...
//        4th |
//            v
const borderTop = line(width / 2, 0, width, lineWidth);
const borderRight = line(width, height / 2, lineWidth, height);
const borderBottom = line(width / 2, height, width, lineWidth);
const borderLeft = line(0, height / 2, lineWidth, height);

const d = lineWidth * 1.5 + w / 2 + padding;
const gate1 = line(width / 5, height - d, width / 2.5, w);
const gate2 = line(width - lineWidth * 2, height / 5, w, height / 2.5);
...
const coordinates = [
    [lineWidth + padding / 2, lineWidth + padding / 2],
    [width - (lineWidth + padding / 2), lineWidth + padding / 2],
    [width - (lineWidth + padding / 2), height - (lineWidth + padding / 2)],
    [lineWidth + padding / 2, height - (lineWidth + padding / 2)],
];
const randomItem = arr => arr[Math.floor(Math.random() * arr.length)];

const goal = Bodies.rectangle(...randomItem(coordinates), lineWidth, lineWidth, {
    render: {
...
const player = Bodies.circle(width / 2, height / 2, lineWidth / 2, {
    render: {
